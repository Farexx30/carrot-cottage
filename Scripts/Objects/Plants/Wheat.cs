...
public partial class Wheat : Node2D
{
    private const int FrameShift = 40;

    private readonly PackedScene _harvestScene = GD.Load<PackedScene>("res://Scenes/Objects/Plants/WheatHarvest.tscn");
    ...
    {
        var wheatHarvestInstance = _harvestScene.Instantiate<Sprite2D>();
