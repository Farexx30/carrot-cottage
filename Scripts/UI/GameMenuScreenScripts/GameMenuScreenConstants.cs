...
public static class GameMenuScreenConstants
{
    public static class Nodes
    {
        ...
        public const string MusicToggleButton = "MarginContainer/HBoxContainer/MusicHBoxContainer/MusicButton";
        public const string SFXToggleButton = "MarginContainer/HBoxContainer/SFXHBoxContainer/SFXButton";
    }
